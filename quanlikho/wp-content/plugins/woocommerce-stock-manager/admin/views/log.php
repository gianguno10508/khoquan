			...
			<div class="box-body">
				<div class="clear"></div>
					<table class="table-bordered">
						<tr>
							<th><?php esc_html_e( 'ID Sản phẩm', 'woocommerce-stock-manager' ); ?></th>
							<th><?php esc_html_e( 'mã SKU', 'woocommerce-stock-manager' ); ?></th>
							<th><?php esc_html_e( 'Tên sản phẩm', 'woocommerce-stock-manager' ); ?></th>
							<th><?php esc_html_e( 'Loại hình sản phẩm', 'woocommerce-stock-manager' ); ?></th>
							<th><?php esc_html_e( 'Mã sản phẩm cha', 'woocommerce-stock-manager' ); ?></th>
							<th><?php esc_html_e( 'Số lượng còn trong kho', 'woocommerce-stock-manager' ); ?></th>
							<th></th>
						</tr>
						<?php
							...
							foreach ( $products->posts as $item ) {
								...
								?>
									...
									<?php if ( 'variable' !== $product_type ) { ?>
												<a class="btn btn-success" href="<?php echo esc_url( admin_url() . 'admin.php?page=stock-manager-log&product-history=' . $item_product->get_id() ); ?>"><?php esc_html_e( 'Lịch sử', 'woocommerce-stock-manager' ); ?></a>
											<?php } ?>
										</td>
									</tr>
									<?php
