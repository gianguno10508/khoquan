...
<div class="wrap">
	...
	<div class="t-col-6">
		<div class="toret-box box-info">
			<div class="box-header">
				<h3 class="box-title"><?php esc_html_e( 'Xuất Excel', 'woocommerce-stock-manager' ); ?></h3>
			</div>
			<div class="box-body">
				<h4><?php esc_html_e( 'Bấm nút để xuất số lượng sản phẩm ra file excel ', 'woocommerce-stock-manager' ); ?></h4>
				<p><a href="#" class="btn btn-danger product-export"><?php esc_html_e( 'Xuất file', 'woocommerce-stock-manager' ); ?></a></p> 
